...
Zaldibazar an ultimate market place to shop your dream things.
...
To run the tests, enter the zaldibazar_repo/tests directory and run the following commands::
